...
from crypto_market_making.connectors.data_types.web_socket_data_types.ws_response import WSResponse
from crypto_market_making.connectors.data_types.web_socket_data_types.ws_request import WSRequest
...
class WSConnector:
    ...
    async def connect(
        ...
        '''
        Connect to websocket for provided session
        :param ws_url:
        :param ping_timeout:
